...
\begin{circuitikz}[loops/.style={circuitikz/inductors/coils=#1}]]
    ...
    \node[thick, fit={(\platineX+1, \platineY) (\platineX+5, \platineY-5)},inner sep=0, align=center] {\small Platine\\Relaisansteuerung};
    ...
    \draw[-latex reversed] (\platineX, \platineY-2.25) -- ++(-.5,0) node[left] {\scriptsize A2};
