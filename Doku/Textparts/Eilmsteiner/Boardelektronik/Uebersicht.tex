...
\begin{circuitikz}[loops/.style={circuitikz/inductors/coils=#1}]]
    ...
    \foreach \i in {0,4,8,12}
        ...
        \draw[thick] (0.9,\i+1.2) to [short,-] ++ (\platinenX1-0.9,0) node[right] {\scriptsize Vin};
    ...
    \draw[-latex reversed,thick] (0.6,12+0.8) -- (0.6,15.5) -- (1.4,15.5) node[right] {\scriptsize CAN-GND};
    \draw[-latex reversed,thick] (0.9,12+1.2) -- (0.9,15)  -- (1.4,15) node[right] {\scriptsize CAN-VCC};
    ...
    %}
    \draw [thick,latex-] (\platinenX2,11.2+0.0) -- (11,11.2+0.0) node [at start,left] {\scriptsize \Values(1)} node [right] {\scriptsize \ValuesScreen(1)};
    \draw [thick,-latex] (\platinenX2,11.2+0.3) -- (11,11.2+0.3) node [at start,left] {\scriptsize \Values(2)} node [right] {\scriptsize \ValuesScreen(2)};
    \draw [thick] (\platinenX2,11.2+0.6) -- (11,11.2+0.6) node [at start,left] {\scriptsize \Values(3)} node [right] {\scriptsize \ValuesScreen(3)};
    \draw [thick] (\platinenX2,11.2+0.9) -- (11,11.2+0.9) node [at start,left] {\scriptsize \Values(4)} node [right] {\scriptsize \ValuesScreen(4)};
    ...
    %}
    \draw [thick,-latex] (\platinenX2,13.1+0.0) -- (11,13.1+0.0) node [at start,left] {\scriptsize \Values(1)} node [right] {\scriptsize \ValuesScreen(1)};
    \draw [thick,latex-] (\platinenX2,13.1+0.3) -- (11,13.1+0.3) node [at start,left] {\scriptsize \Values(2)} node [right] {\scriptsize \ValuesScreen(2)};
    \draw [thick] (\platinenX2,13.1+0.6) -- (11,13.1+0.6) node [at start,left] {\scriptsize \Values(3)} node [right] {\scriptsize \ValuesScreen(3)};
    \draw [thick] (\platinenX2,13.1+0.9) -- (11,13.1+0.9) node [at start,left] {\scriptsize \Values(4)} node [right] {\scriptsize \ValuesScreen(4)};
