\lstset {
    ...
    emph={
        uint16_t, uint32_t, size_t, string, std, override, private, public, class, int, double, float, char, long, bool, void, protected, virtual, static, volatile, __cplusplus, extern, ISR,  TIMER1_COMPA_vect,TIMER0_COMPA_vect, true, false, this, namespace, if, else, for, while, return, sizeof, new, delete, unsigned
...
\lstinputlisting[basicstyle=\scriptsize]{../Programmierung/Regler_Controller/src/main.cpp}
\newpage
\subsection{Lenker}
\subsubsection{Aufgaben \& verwendete Bauteile}
...
\newpage
\subsubsection{Programmcode}
\lstinputlisting[basicstyle=\scriptsize]{../Programmierung/Lenker_Controller/src/main.cpp}
...
\newpage
\subsubsection{Programmcode}
\lstinputlisting[basicstyle=\scriptsize]{../Programmierung/Servo_ADC_Controller/src/main.cpp}
\newpage
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.62\textwidth]{../Proteus/Exports/Temperatursensoren-Platine.png}    
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{../Proteus/Exports/Temperatursensoren-Platine-PCB.png}    
