...
\begin{circuitikz}[loops/.style={circuitikz/inductors/coils=#1}]]
    ...
    % Motorregler, Motor
    \draw (\offxmotor, \offymotor-.25) -- (\offxmotor-1.5,\offymotor-.25);
    \draw (\offxmotor, \offymotor) -- (\offxmotor-1.5,\offymotor);
    \draw (\offxmotor, \offymotor+.25) -- (\offxmotor-1.5,\offymotor+.25);
    ...
    \node[thick, draw, fit={(\offxmotor-4, \offymotor-.6) (\offxmotor-1.5, \offymotor+.6)},inner sep=0, align=center] {\scriptsize Master SPIN 220 PRO OPTO};

    \draw[-latex reversed] (\offxmotor-4, \offymotor-.5) -- (\offxmotor-4.5, \offymotor-.5) node[left] {\scriptsize BLL};
    \draw[-latex reversed] (\offxmotor-4, \offymotor+.5) -- (\offxmotor-4.5, \offymotor+.5) node[left] {\scriptsize BHH};

    % n2
    \draw (\offxmotor, \offymh-.25) -- (\offxmotor-1.5,\offymh-.25);
    \draw (\offxmotor, \offymh) -- (\offxmotor-1.5,\offymh);
    \draw (\offxmotor, \offymh+.25) -- (\offxmotor-1.5,\offymh+.25);
    \draw (\offxmotor, \offymh) node[very thick, circle, draw, minimum size=3, fill=white] {A200};

    \node[thick, draw, fit={(\offxmotor-4, \offymh-.6) (\offxmotor-1.5, \offymh+.6)},inner sep=0, align=center] {\scriptsize Master SPIN 220 PRO OPTO};

    \draw[-latex reversed] (\offxmotor-4, \offymh-.5) -- (\offxmotor-4.5, \offymh-.5) node[left] {\scriptsize BLL};
    \draw[-latex reversed] (\offxmotor-4, \offymh+.5) -- (\offxmotor-4.5, \offymh+.5) node[left] {\scriptsize BHH};
