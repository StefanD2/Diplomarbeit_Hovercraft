...
\begin{minipage}{7.5cm}
    \textcolor{Green}{Hauptrelais (A- \& GND)}\\
    \textcolor{blue}{Micro-Switches}\\
    \textcolor{orange}{Buck-Converter (nicht mehr verwendet)}\\
    \textcolor{violet}{geschaltene Relaisseite}\\
